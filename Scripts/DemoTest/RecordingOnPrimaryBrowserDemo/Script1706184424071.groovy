...
WebUI.setText(findTestObject('Object Repository/Page_Your store. Login/input_Email'), 'admin@yourstore.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Your store. Login/input_Password'), 'RAIVpflpDOg=')
...
WebUI.click(findTestObject('Object Repository/Page_Dashboard  nopCommerce administration/a_Customers'))
