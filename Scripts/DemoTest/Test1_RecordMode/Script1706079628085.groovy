...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_form-group'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_comment'), 'This Test Comment')
